    ...
    while True:
        ...
        if state == TaskState.Completed:
            ...
            if serials:
                ...
                print(f"[INFO] Task completed. Serial: {result_serial}")
...
#     #Validate arguments
#     if len(sys.argv) < 3:
#         print("This script must be ran with arguments of file_path, result_path")
#         sys.Exit()
...
#     response = server.submit(file_path)
#     server.print_response(response)
#     taskId = response.get('TaskId')
